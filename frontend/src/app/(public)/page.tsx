...
export default function Home() {
  return (
    <div className={styles.page}>
      <header style={{ display: 'flex', alignItems: 'center', gap: 14, padding: '2rem 0 0 0' }}>
  <span style={{ fontWeight: 800, fontSize: '2rem', color: '#2563eb', letterSpacing: '0.01em' }}>AI Recruitment Portal</span>
  <Logo width={54} height={54} />
      ...
      <section className={styles.hero}>
        ...
        <div className={styles.heroImage}>
          <picture>
  <source srcSet="/photo-1506744038136-46273834b3fb.avif" type="image/avif" />
  <img src="/hero-unsplash.jpg" alt="Team collaborating" width={380} height={320} style={{ borderRadius: '1rem', objectFit: 'cover' }} loading="eager" />
</picture>
        </div>
      </section>
      ...
      <section className={styles.features}>
        ...
        <div className={styles.featureGrid}>
          <div className={styles.featureCard}>
            <Image src="/ai-icon.svg" alt="AI CV Analysis" width={56} height={56} />
            <h3>AI CV Analysis</h3>
            <p>Upload your CV and receive instant, actionable feedback powered by AI.</p>
          </div>
          <div className={styles.featureCard}>
            <Image src="/teamwork.svg" alt="Smart Job Search" width={56} height={56} />
            <h3>Smart Job Search</h3>
            <p>Discover jobs tailored to your skills and interests with advanced search filters.</p>
          </div>
          <div className={styles.featureCard}>
            <Image src="/ai-icon.svg" alt="Application Tracking" width={56} height={56} />
